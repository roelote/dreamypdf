    ...
    <section style="margin: 15pt 15pt">
       <header>
        ...
        <article class="mt-5">
          ...
          <div class="fi">
            <div class="px-4">
                {{-- <span class="font text-center">ITINERARIO</span> --}}
                <h2 class="itine">ITINERARIO</h2>
                {!!$id->itinerario!!}
            </div>
          </div>
          <div class="fi">
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><img src="" alt="" style="width: 265px; height:350px;"></td>
                  <td><img src="" alt="" style="width: 265px; height:350px;"></td>
                </tr>
                <tr>
                 <td><img src="" alt="" style="width: 265px;  height:350px;"></td>
         ...
         <article class="mt-5">
          ...
          <div class="fi">
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td><img src="" alt="" style="width: 506px; height:350px;"></td>
                </tr>
                <tr>
                 <td><img src="" alt="" style="width: 506px;  height:350px;"></td>
                </tr>
        ...
        <header>
          ...
          <p>Mantenemos una amplia y variada flota de vehículos de diferentes modelos y capacidades, siempre preparados para brindarte la mejor atención, cumpliendo con todos los protocolos de Bioseguridad.</p>
            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td style="width: 33%"><img src="img/1.jpg" alt="" style="width: 100%; height:460px;"></td>
                  <td style="width: 33%"><img src="img/1.jpg" alt="" style="width: 100%; height:460px;"></td>
                  <td style="width: 33%"><img src="img/1.jpg" alt="" style="width: 100%; height:460px;"></td>
                </tr>
